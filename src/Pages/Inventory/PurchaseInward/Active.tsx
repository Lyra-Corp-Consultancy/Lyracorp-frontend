...
import { activeAndDeactivePurchaseInward } from "../../../utils/redux/actions";
...
function Active({ data, dropDowns, inActiveCustomer,selected,setSelected }: Prop) {
    ...
    <div className="h-[80%]  w-full">
            ...
            <tr className="border relative">
              ...
              <th className="relative ">
                ...
                <div className={"hidden hover:flex flex-col gap-[1px] absolute right-0 z-20 " + styles.option}>
                  ...
                  <button onClick={()=>navigate("/inventory/purchase-inward/edit/"+x?._id)} className="bg-[#E0E4FF] rounded-md shadow-md shadow-[#00000040] gap-2 items-center text-black flex px-2 py-1">
      ...
      {inactive && (
        <DeleteConfirmationBox
          ...
          ResolveFunction={() => {
            dispatch(activeAndDeactivePurchaseInward([inactive])).then(() => {
              inActiveCustomer();
              setInactive("")
            });
          }}
