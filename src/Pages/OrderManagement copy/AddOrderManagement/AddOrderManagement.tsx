...
function AddOrderManagement() {
  ...
  const handleSave = async () => {
    ...
    // }
    dispatch(postOrderManagement({ ...val })).then(() => {
      navigate(-1);
    });
  };
                ...
                <tr className={`text-center relative `} style={{ zIndex: 500 - i }}>
                  <td className="text-center  border  justify-center py-2 items-center ">
                    <div className="flex justify-center items-center">
                      <Select
                        ...
                        pattern={products?.filter((x) => x?.productName === searchValue.products[i])[0]?.productName ? undefined : ""}
                        title="Please Select values from drop down"
                        onChange={(e) => {
                  ...
                  <td className="text-center  border  justify-center py-2 items-center ">
                    <div className="flex justify-center items-center">
                      <Select
                        ...
                        pattern={batch[0]?.filter((x: any) => x?.batchNumbers === searchValue.batchNumbers[i])?.[0]?.batchNumbers ? undefined : ""}
                        title="Please Select values from drop down"
                        onChange={(e) => {
                  ...
                  <td className="text-center border justify-center py-2 items-center ">
                    <Select
                      style={{ zIndex: 997 - i }}
                      className="w-[90%] shadow-none bg-[#e2e2e2]"
                      pattern={dropDowns?.shipping?.filter((x) => x?.value === searchValue.shippingType[i])?.[0]?.value ? undefined : ""}
                      title="Please Select values from drop down"
                      onChange={(e) => {
