...
function ActiveOrder({ data, dropDowns, inActiveUser, selected, setSelected }: Prop) {
      ...
      <table className="w-full mt-3 overflow-auto">
        <thead className="border w-full top-0 left-0  text-xs text-center bg-[#5970F5] text-white roboto-thin">
          <tr className="w-full">
            ...
            <th>Order Value</th>
            <th>Delivery Date</th>
            <th className="w-[10px]">Billing Address</th>
            ...
            <tr className="border relative">
              ...
              <th className="relative ">
                ...
                <div className={"hidden hover:flex flex-col gap-[1px] absolute right-0 z-20 " + styles.option}>
                  ...
                  <button onClick={() => navigate("/order-management/view/"+x?._id )} className="bg-[#E0E4FF] rounded-md shadow-md shadow-[#00000040] gap-2 items-center text-black flex px-2 py-1">
                  ...
                  <button onClick={() => navigate("/order-management/edit/"+x?._id )} className="bg-[#E0E4FF] rounded-md shadow-md shadow-[#00000040] gap-2 items-center text-black flex px-2 py-1">
