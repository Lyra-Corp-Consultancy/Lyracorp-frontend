        ...
        <div className="bg-[#F1F3FF] shadow-md mt-2 w-full p-4 rounded-lg h-full">
          <div className="bg-white rounded-lg w-full pt-3 h-[80%] shadow-md mt-4">
            ...
            <div className="px-4 flex  justify-start gap-7 items-center">
              ...
              <Link to={"/master/profile-master/add-profile"} className="bg-[#5970F5] flex px-3 py-2 rounded-md text-white gap-2 items-center">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex flex-col ">
                      ...
                      <div className="flex ">
                        ...
                        <svg width="12" className="cursor-pointer" onClick={()=>navigate("/master/profile-master/edit-profile/"+x?._id)} height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
