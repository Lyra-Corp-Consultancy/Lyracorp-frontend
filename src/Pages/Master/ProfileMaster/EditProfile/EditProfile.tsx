...
import { editProfileMaster, getProfileMasterById, getType } from "../../../../utils/redux/actions";
      ...
      <div className="bg-[#F1F3FF] shadow-md px-3 pt-3 pb-10 rounded-lg w-full ">
        ...
        >
          ...
          <div className="w-full absolute bottom-4 justify-center items-center gap-3 flex mt-5">
            ...
            <button type="submit" className=" rounded-md py-2 px-4 font-semibold border border-[#5970F5] text-[#5970F5]">
              Edit
            </button>
          </div>
        </form>
