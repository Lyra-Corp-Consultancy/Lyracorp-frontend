...
function EditProfile() {
  ...
  const handleSave = async () => {
    ...
    dispatch(
      editProfileMaster({
        data: { ...data, fileUrls: [...urls, ...data.fileUrls], logo },
        id: params.id,
      })
    ).then(() => {
      navigate(-1);
  ...
  useEffect(() => {
    setSearchValue({
      ...
      businessType: dropDowns?.account?.filter(
        (x) => x?._id === data?.businessType
      )[0]?.value,
    ...
    <div className=" w-screen px-4 pt-3 shadow-md">
      ...
      <div className="bg-[#F1F3FF] shadow-md px-3 pt-3 pb-10 rounded-lg w-full ">
        <form
          ...
          className="shadow-md bg-white px-4 pb-[200px] h-full z-[0] relative rounded-lg pt-1 w-full"
        >
          ...
          <div className="grid grid-flow-col items-center gap-4 roboto-medium text-[13px] shadow-[0px_0px_4px_rgba(0,0,0,0.485)] w-full rounded-lg px-3 py-2">
            ...
            <div className="flex gap-3">
              <label
                htmlFor="file"
                className="flex items-center gap-3 justify-center shadow-[0px_0px_4px_rgba(0,0,0,0.385)] h-[40px] bg-[#ECECEC] w-[40px] px-3 py-2 rounded-md"
                onDrop={handleDrop2}
            ...
            <Select
              pattern={
                dropDowns?.account?.filter(
                  (a) => a?.value === searchValue?.businessType
                )[0]
                  ? undefined
                  : ""
              }
              ...
              value={searchValue?.businessType || ""}
            >
              {dropDowns?.account
                ?.filter((a) =>
                  a?.value
                    ?.toLowerCase()
                    ?.includes(searchValue?.businessType?.toLowerCase() || "")
                )
                .map((x) => (
                  <li
                    onClick={() => {
          ...
          >
            <div className="w-[22%] flex gap-3 items-center">
              ...
              <Select
                // pattern={
                //   places?.country?.filter(
                //     (a) => a?.country === data?.country
                //   )[0]
                //     ? undefined
                //     : ""
                // }
            ...
            <div className="flex items-center">
              <div className="flex mt-3 flex-wrap gap-2 items-center justify-between roboto-medium text-[13px] shadow-[0px_0px_4px_rgba(0,0,0,0.485)] w-full rounded-lg px-3 py-2">
                <div className="w-[22%] flex justify-between gap-3 items-center">
                  ...
                  <Select
                    // pattern={
                    //   places?.country?.filter(
                    //     (a) => a?.country === data?.billingAddress[i]?.country
                    //   )[0]
                    //     ? undefined
                    //     : ""
                    // }
                ...
                <div className="w-[22%] flex justify-between gap-3 items-center">
                  ...
                  <Select
                    // pattern={
                    //   places?.state?.filter(
                    //     (a) => a?.name === data?.billingAddress[i].state
                    //   )[0]
                    //     ? undefined
                    //     : ""
                    // }
              ...
              {i > 0 && (
                <button
                  ...
                  className="bg-red-500 rounded-full h-5 flex items-center justify-center text-white w-5"
                >
                  -
                </button>
              )}
              ...
              <div className="flex mt-3 flex-wrap gap-2 items-center justify-between roboto-medium text-[13px] shadow-[0px_0px_4px_rgba(0,0,0,0.485)] w-full rounded-lg px-3 py-2">
                <div className="w-[22%] flex justify-between  gap-3 items-center">
                  ...
                  <Select
                    // pattern={
                    //   places?.country?.filter(
                    //     (a) => a?.country === data?.shippingAddress[i]?.country
                    //   )[0]
                    //     ? undefined
                    //     : ""
                    // }
                ...
                <div className="w-[22%] flex justify-between  gap-3 items-center">
                  ...
                  <Select
                    // pattern={
                    //   places?.state?.filter(
                    //     (a) => a?.name === data?.shippingAddress[i].state
                    //   )[0]
                    //     ? undefined
                    //     : ""
                    // }
                      ...
                      <li
                        onClick={() => {
                          ...
                          axios
                            .post(
                              "https://countriesnow.space/api/v0.1/countries/state/cities",
                              { country: x.country, state: x?.name }
                            )
                            .then((res) => {
                              console.log(res.data);
                              setPlaces({ ...places, city: res.data.data });
                ...
                <div className="w-[22%] z-10 flex justify-between  gap-3 items-center">
                  ...
                  <Select
                    // pattern={
                    //   places?.city?.filter(
                    //     (a) => a === data?.shippingAddress[i]?.city
                    //   )[0]
                    //     ? undefined
                    //     : ""
                    // }
              ...
              <div className="w-[22%] flex justify-between gap-3 items-center">
                ...
                <div className="w-[22%] flex justify-between gap-3 items-center">
                  ...
                  <Select
                    // pattern={
                    //   places?.country?.filter(
                    //     (a) => a?.country === data?.warehouse[i]?.country
                    //   )[0]
                    //     ? undefined
                    //     : ""
                    // }
                ...
                <div className="w-[22%] flex justify-between gap-3 items-center">
                  ...
                  <Select
                    // pattern={
                    //   places?.state?.filter(
                    //     (a) => a?.name === data?.warehouse[i].state
                    //   )[0]
                    //     ? undefined
                    //     : ""
                    // }
          ...
          <div className="flex mt-3 w-full items-end justify-end">
            <button
              type="button"
              onClick={() =>
                setData({ ...data, warehouse: [...data.warehouse, {}] })
              }
              className="bg-[#5970F5] text-white px-4 py-2 rounded-md"
            >
              + Add{" "}
          ...
          <div className="grid grid-cols-4 items-center justify-between roboto-medium text-[13px] shadow-[0px_0px_4px_rgba(0,0,0,0.485)]  w-full rounded-lg px-3 py-2">
            ...
            <div className="flex gap-3 items-center">
              ...
              <input
                ...
                name="gstinNumber"
                onChange={(e) =>
                  setData({ ...data, gstinNumber: e.target.value })
                }
                type="text"
                className="px-2 py-1 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md  w-[200px]"
              />
          ...
          <div className="grid grid-cols-4 items-center justify-between roboto-medium text-[13px] shadow-[0px_0px_4px_rgba(0,0,0,0.485)]  w-full rounded-lg px-3 py-2">
            <div className="flex gap-3 items-center">
              ...
              <input
                ...
                name="bankAccNo"
                onChange={(e) =>
                  setData({ ...data, bankAccNo: e.target.value })
                }
                type="text"
                className="px-2 py-1 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md  w-[200px]"
              />
            ...
            <div className="flex gap-3 items-center">
              ...
              <input
                ...
                name="accBranch"
                onChange={(e) =>
                  setData({ ...data, accBranch: e.target.value })
                }
                type="text"
                className="px-2 py-1 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md  w-[200px]"
              />
              ...
              <div className="flex gap-3 items-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setData({
                      ...data,
                      grn: { ...data?.grn, prefix: e.target.value },
                    })
                  }
                  type="text"
                  className="px-2 py-1 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md  w-[200px]"
              ...
              <div className="flex gap-3 items-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setData({
                      ...data,
                      grn: { ...data?.grn, seq: parseInt(e.target.value) },
                    })
                  }
                  type="number"
                  className="px-2 py-1 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md  w-[200px]"
              ...
              <div className="flex gap-3 items-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setData({
                      ...data,
                      invoice: { ...data?.invoice, prefix: e.target.value },
                    })
                  }
                  type="text"
                  className="px-2 py-1 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md  w-[200px]"
              ...
              <div className="flex gap-3 items-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setData({
                      ...data,
                      gatePass: { ...data?.gatePass, prefix: e.target.value },
                    })
                  }
                  type="text"
                  className="px-2 py-1 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md  w-[200px]"
