                    ...
                    <div className='bg-white rounded-lg w-full pt-3 h-[80%] shadow-md mt-4'>
                        ...
                        <div className='px-4 flex justify-between'>
                            <label className='flex px-3 w-2/5 rounded-md py-1 mt-2 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] items-center gap-3' htmlFor="">
                                ...
                                <input type="text" placeholder='Search' className='placeholder:text-black outline-none border-none' />
                            </label>
                            <div className='flex items-center gap-3'>
                        ...
                        <table className='w-full mt-3'>
                            <thead className='border text-xs text-center bg-[#5970F5] text-white roboto-thin'>
                                <tr>
                                    <th><div className='h-3 cursor-pointer w-3 border border-white bg-none'></div></th>
                                    <th>S No</th>
                            ...
                            <tbody className='border text-xs text-center  text-[#5970F5] roboto-thin'>
                                <tr>
                                    <th><div className='h-3 cursor-pointer w-3 border border-[#5970F5] bg-none'></div></th>
                                    <th>S No</th>
                                    <th>Customer Acc No</th>
                                    <th>Customer Name</th>
                                    <th>Customer Type</th>
                                    ...
                                    <th>Discount Type</th>
                                    <th>Payment Terms</th>
                                    <th className='cursor-pointer flex items-center justify-center pt-1'><svg width="2" height="9" viewBox="0 0 2 9" fill="none" xmlns="http://www.w3.org/2000/svg">
