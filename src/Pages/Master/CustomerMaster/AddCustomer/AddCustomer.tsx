      ...
      <div className="bg-[#F1F3FF] shadow-md p-3 rounded-lg w-full min-h-[90%]">
        ...
        >
          ...
          <div className="grid grid-flow-col items-center gap-4 roboto-medium text-[13px] shadow-[0px_0px_4px_rgba(0,0,0,0.485)] w-full rounded-lg px-3 py-2">
            ...
            <Select
              pattern={dropDowns?.customer?.filter((a) => a?.value === searchValue?.customer)[0] ? undefined : ""}
            ...
            <Select
              pattern={dropDowns?.account?.filter((a) => a?.value === searchValue?.account)[0] ? undefined : ""}
              title="Please Select values from drop down"
              onChange={(e) => {
          ...
          <div className="grid grid-flow-col z-[100] items-center gap-4 roboto-medium text-[13px] shadow-[0px_0px_4px_rgba(0,0,0,0.485)] w-full rounded-lg px-3 py-2">
            ...
            <label className="px-2 py-1 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] flex rounded-md">
              ...
              <input
                ...
                onChange={(e) => setData({ ...data, primaryNumber: e.target.value })}
                type="number"
              />
            </label>
            ...
            <input
              ...
              onChange={(e) => setData({ ...data, secondaryNumber: e.target.value })}
              type="number"
            ...
            {data?.state && (
              <>
                ...
                <div className="w-[22%] flex gap-3 items-center">
                  ...
                  <input value={data.pincode} min={6} onChange={(e) => setData({ ...data, pincode: e.target.value })} type="number" className="px-2 py-1 remove-spin-wheel shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md" />
                </div>
              </>
            )}
          </div>
          ...
          <div className="grid z-[98] grid-flow-col items-center gap-4 roboto-medium text-[13px] shadow-[0px_0px_4px_rgba(0,0,0,0.485)] w-full rounded-lg px-3 py-2">
            ...
            <Select
              pattern={dropDowns?.discount?.filter((a) => a?.value === searchValue?.discount)[0] ? undefined : ""}
              title="Please Select values from drop down"
              onChange={(e) => {
            ...
            <Select
              pattern={dropDowns?.paymentTerm?.filter((a) => a?.value === searchValue?.paymentTerm)[0] ? undefined : ""}
              title="Please Select values from drop down"
              onChange={(e) => {
