...
import { activeAndDeactiveProductMaster } from "../../../utils/redux/actions";
    ...
    <div className="h-[80%] overflow-auto w-full">
            ...
            <tr className="border relative">
              ...
              <th className="relative ">
                ...
                <div className={"hidden hover:flex flex-col gap-[1px] absolute right-0 z-20 " + styles.option}>
                 {permissions?.delete?.includes("product master") &&  <button
                    onClick={() => {
                      setInactive(x?._id);
                    }}
                  ...
                  <button onClick={()=>navigate("/master/product-master/view-products/"+x?._id)} className="bg-[#E0E4FF] rounded-md shadow-md shadow-[#00000040] gap-2 items-center text-black flex px-2 py-1">
                 ...
                 {permissions?.edit?.includes("product master") && <button onClick={()=>navigate("/master/product-master/edit-products/"+x?._id)} className="bg-[#E0E4FF] rounded-md shadow-md shadow-[#00000040] gap-2 items-center text-black flex px-2 py-1">
      ...
      {inactive && (
        <DeleteConfirmationBox
          ...
          ResolveFunction={() => {
            dispatch(activeAndDeactiveProductMaster([inactive])).then(() => {
              inActiveCustomer();
              setInactive("")
            });
          }}
