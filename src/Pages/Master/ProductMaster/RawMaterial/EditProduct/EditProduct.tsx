...
function EditProductRawMaterial() {
  ...
  useEffect(() => {
    setSearchValue({
      margin: dropDowns?.margin?.filter((x) => x?._id === data?.marginType)[0]
        ?.value,
      ...
      uom: dropDowns?.uom?.filter((x) => x?._id === data?.uomType)[0]?.value
        .name,
    });
  }, [dropDowns, data]);
  ...
  useEffect(() => {
    ...
    dispatch(getProductRawMaterialById(params.id)).then((res: any) => {
      setData(res.payload);
  ...
  return (
    <div className="h-[110vh] w-screen px-4 pt-3 shadow-md">
      <h1 className="roboto-bold text-lg">Edit Raw Material Master</h1>
        ...
        >
          ...
          <div className="grid grid-cols-4 items-center gap-4 roboto-medium text-[13px] shadow-[0px_0px_4px_rgba(0,0,0,0.485)] w-full rounded-lg px-3 py-2">
            ...
            <div className="flex gap-3 z-[999] items-center">
              ...
              >
                {
                  dropDowns?.uom?.filter((x) => x?._id === data?.uomType)[0]
                    ?.value?.des
                }
              </label>
            </div>
            <div className="flex gap-3 items-center">
              ...
              <input
                ...
                name="storageSpec"
                onChange={(e) =>
                  setData({ ...data, storageSpec: e.target.value })
                }
                className="px-2 py-1 w-[60%] shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-4 items-center justify-between roboto-medium text-[13px] shadow-[0px_0px_4px_rgba(0,0,0,0.485)]  w-full rounded-lg px-3 py-2">
              ...
              >
                ...
                <Calendar
                  onChange={(e) => {
                    setData({
                      ...data,
                      pricingDate: e?.toLocaleString().split(",")[0],
                    });
                  }}
                  className={[
            ...
            <div className="flex gap-5 items-end">
              ...
              >
                ...
                <input
                  ...
                  type="number"
                  className="px-2 remove-spin-wheel py-1 w-[50px] shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md"
                />
              </label>
            ...
            <div className="flex gap-3 items-center">
              ...
              <input
                ...
                name="targetPrice"
                onChange={(e) =>
                  setData({ ...data, targetPrice: e.target.value })
                }
                type="number"
                className="px-2 remove-spin-wheel py-1 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md"
              />
            ...
            <div className="flex gap-3 items-center">
              ...
              <input
                ...
                name="floorPrice"
                onChange={(e) =>
                  setData({ ...data, floorPrice: e.target.value })
                }
                type="number"
                className="px-2 remove-spin-wheel py-1 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md"
              />
          ...
          <div className="grid grid-cols-4 items-center gap-4 roboto-medium text-[13px] shadow-[0px_0px_4px_rgba(0,0,0,0.485)] w-full rounded-lg px-3 py-2">
            ...
            <div className="flex gap-3 items-center">
              ...
              <input
                ...
                name="eanNumber"
                onChange={(e) =>
                  setData({ ...data, eanNumber: e.target.value })
                }
                type="text"
                className="px-2 py-1 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md"
              />
            ...
            <div className="flex gap-5 items-end">
              ...
              >
                ...
                <input
                  ...
                  type="number"
                  className="px-2  py-1 w-[50px] shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md"
                />
              </label>
...
export default EditProductRawMaterial;
