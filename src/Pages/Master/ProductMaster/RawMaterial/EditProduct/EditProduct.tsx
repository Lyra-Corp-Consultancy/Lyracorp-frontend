...
import { editProductRawMaterial, getProductRawMaterialById, getType } from "../../../../../utils/redux/actions";
...
function EditProductRawMaterial() {
  ...
  const handleSave = async () => {
    ...
    dispatch(editProductRawMaterial({data:{ ...data, fileUrls: urls },id:params.id})).then(() => {
      navigate(-1);
    });
  };
