...
import { getProductRawMaterialById, getType } from "../../../../../utils/redux/actions";
...
function ViewProductRawMaterial() {
  ...
  return (
    <div className="h-[110vh] w-screen px-4 pt-3 shadow-md">
      <h1 className="roboto-bold text-lg">View Raw Material Master</h1>
      <div className="bg-[#F1F3FF] shadow-md p-3 rounded-lg w-full h-[90%]">
        <div className="shadow-md bg-white px-4 h-full z-[0] relative rounded-lg pt-1 w-full">
          ...
          <button className="border rounded-md py-2 px-4 font-semibold border-[#5970F5] text-[#5970F5]" onClick={() => navigate(-1)}>
            ...
            {permissions?.edit?.includes("raw material") &&<button className="border rounded-md py-2 px-4 font-semibold border-[#5970F5] text-[#5970F5]" onClick={() => navigate("/master/product-master/raw-material/edit/"+params?.id)}>
              Edit
            </button>}
