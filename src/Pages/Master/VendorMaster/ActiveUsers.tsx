...
import styles from "./VendorMaster.module.scss";
            ...
            <tr className="border relative">
              ...
              <th className="relative ">
                ...
                <div className={"hidden hover:flex flex-col gap-[1px] absolute right-0 z-20 " + styles.option}>
                 {permissions?.delete?.includes("vendor master") &&  <button
                    onClick={() => {
                      setInactive(x?._id);
                    }}
                 ...
                 {permissions?.edit?.includes("vendor master") &&  <button onClick={()=>navigate("/master/vendor-master/edit-vendors/"+x?._id)} className="bg-[#E0E4FF] rounded-md shadow-md shadow-[#00000040] gap-2 items-center text-black flex px-2 py-1">
