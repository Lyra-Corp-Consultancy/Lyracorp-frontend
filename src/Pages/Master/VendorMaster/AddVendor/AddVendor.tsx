...
function AddVendor() {
  ...
  const [searchValue, setSearchValue] = useState<{
    ...
    vendor?: string;
    countryCode: any;
  }>({ payment: "", document: "", vendor: "" ,countryCode: ""});
    ...
    <div className="min-h-[90vh] w-screen px-4 pt-3 shadow-md">
      ...
      <div className="bg-[#F1F3FF] shadow-md p-3 rounded-lg w-full min-h-[90%]">
        <form
          ...
          className="shadow-md bg-white px-4 h-full z-[0] pb-[100px] relative rounded-lg pt-1 w-full"
        >
          ...
          <div className="grid grid-cols-4 items-center gap-4 roboto-medium text-[13px] shadow-[0px_0px_4px_rgba(0,0,0,0.485)] w-full rounded-lg px-3 py-2">
            ...
            <div className="flex gap-2 items-center">
              ...
              <input
                required
                value={data.accountBranch}
                onChange={(e) =>
                  setData({ ...data, accountBranch: e.target.value })
                }
                type="text"
                className="px-2 py-1 shadow-[0px_0px_4px_rgba(0,0,0,0.385)] rounded-md"
              />
